...
float fusion(const t_param params, t_speed*  cells, t_speed*  tmp_cells, int*  obstacles){
  ...
  _assume_aligned(cells->speed0, 64);
  _assume_aligned(cells->speed1, 64);
  _assume_aligned(cells->speed2, 64);
  _assume_aligned(cells->speed3, 64);
  _assume_aligned(cells->speed4, 64);
  _assume_aligned(cells->speed5, 64);
  _assume_aligned(cells->speed6, 64);
  _assume_aligned(cells->speed7, 64);
  _assume_aligned(cells->speed8, 64);
